...
export function Wordmark({ size = 32, invert = false }: { size?: number; invert?: boolean }) {
  return (
    ...
    >
      <rect x="0" y="20" width="60" height="60" rx="6" fill={invert ? "var(--accent)" : "var(--brand-navy)"} />
      <text x="30" y="59" textAnchor="middle" fontFamily="'Archivo Black','IBM Plex Sans','Helvetica Neue',sans-serif" fontWeight="900" fontSize="24" letterSpacing="0" fill="var(--paper)">BA</text>
