...
import { DisclosureBox } from "@briefasia/ui";
 ...
 * title/body overrides to the @briefasia/ui DisclosureBox primitive (which is i18n-free).
 */
function SponsoredBox({
  ...
  return (
    <DisclosureBox
      ...
      body={t(
        "This is a sponsored feature produced by BriefAsia Studio for the partner above. The BriefAsia newsroom was not involved in writing or editing.",
        "Đây là nội dung tài trợ do BriefAsia Studio sản xuất cho đối tác nêu trên. Toà soạn BriefAsia không tham gia viết hay biên tập.",
        "Ini adalah konten bersponsor yang diproduksi oleh BriefAsia Studio untuk mitra di atas. Ruang redaksi BriefAsia tidak terlibat dalam penulisan atau penyuntingan."
      )}
    />
  );
}
