...
import { PillarTag } from "@briefasia/ui";
...
export function ArticleContent({ article, body, related }: ArticleContentProps) {
  ...
  return (
    <article className="container" style={{ paddingTop: 24, paddingBottom: 32 }}>
      ...
      >
        <Link href="/" className="linkish" style={{ color: "inherit" }}>BriefAsia</Link>
        <span>›</span>
        <Link
          href={pillarSlug}
          className="linkish"
      ...
      {article.affiliate && (
        ...
        >
          ...
          <span>
            ...
            {t(
              "Some links in this review earn BriefAsia a commission. Manufacturers do not approve our reviews, and we do not accept review units in exchange for coverage.",
              "Một số liên kết trong bài đánh giá này mang lại hoa hồng cho BriefAsia. Nhà sản xuất không duyệt bài đánh giá của chúng tôi, và chúng tôi không nhận sản phẩm dùng thử để đổi lấy bài viết.",
              "Beberapa tautan dalam ulasan ini menghasilkan komisi untuk BriefAsia. Produsen tidak menyetujui ulasan kami, dan kami tidak menerima unit ulasan sebagai imbalan liputan."
            )}
          </span>
        </div>
      )}
      ...
      >
        ...
        {t("Email", "Email", "Email")}{" "}
        <span className="mono">editor@briefasia.com</span>.{" "}
        {t(
