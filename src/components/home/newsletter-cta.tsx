    ...
    <section style={{ marginBottom: 32 }}>
      ...
      >
        ...
        <div style={{ position: "relative" }}>
          ...
          >
            {t(
              "AM Brief, PM Brief, AI Weekly, Asia Funding, Dev Digest, Products & Deals, Deep Dive, BriefAsia Awards. Double opt-in. Unsubscribe with one click. We will never sell or share your email.",
              "AM Brief, PM Brief, AI Weekly, Asia Funding, Dev Digest, Products & Deals, Deep Dive, BriefAsia Awards. Xác nhận kép. Hủy chỉ bằng một cú nhấp. Không bán hay chia sẻ email của bạn.",
              "AM Brief, PM Brief, AI Weekly, Asia Funding, Dev Digest, Products & Deals, Deep Dive, BriefAsia Awards. Konfirmasi ganda. Berhenti dengan satu klik. Kami tak akan menjual atau membagikan email Anda."
            )}
          </p>
        </div>
        <form
