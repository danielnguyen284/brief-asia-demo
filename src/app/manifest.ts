...
export default function manifest(): MetadataRoute.Manifest {
  return {
    name: "BriefAsia",
    short_name: "BriefAsia",
    description: "Asia intelligence, briefed daily.",
    start_url: "/",
    display: "standalone",
    background_color: "#FCFBF8", // --paper, shows on the splash screen
    theme_color: "#2E2147", // --navy, matches the site header chrome
    icons: [
