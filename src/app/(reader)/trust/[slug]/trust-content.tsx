...
export function TrustContent({ slug, corrections }: TrustContentProps) {
  ...
  const PAGES: Record<TrustSlug, TrustPageContent> = {
    editorial: {
      ...
      body: [
        ...
        [
          ...
          t(
            "BriefAsia does not accept review units, free travel, or paid trips. Our editorial budget is separate from BriefAsia Studio (sponsored work) and from membership revenue.",
            "BriefAsia không nhận sản phẩm dùng thử, chuyến đi miễn phí hay tài trợ đi lại. Ngân sách biên tập tách biệt với BriefAsia Studio (bài tài trợ) và doanh thu thành viên.",
            "BriefAsia tidak menerima unit ulasan, perjalanan gratis, atau trip berbayar. Anggaran editorial terpisah dari BriefAsia Studio (konten bersponsor) dan pendapatan keanggotaan."
          ),
        ],
        [
    ...
    sponsored: {
      ...
      kicker: t(
        "BriefAsia Studio and review rules",
        "Quy tắc BriefAsia Studio và đánh giá",
        "Aturan BriefAsia Studio dan ulasan"
      ),
      body: [
        [
