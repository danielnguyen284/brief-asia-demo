...
export default function LegalPage() {
  ...
  const PAGES: Record<LegalSlug, LegalPageContent> = {
    privacy: {
      ...
      kicker: updated,
      intro: t(
        "We built BriefAsia to be read, not to be mined. This policy explains, in plain language, what we collect, why, and the control you keep over it. If anything here is unclear, write to info@briefasia.com and a person, not a bot, will answer.",
        "Chúng tôi xây BriefAsia để được đọc, không phải để khai thác dữ liệu. Chính sách này giải thích bằng ngôn ngữ rõ ràng: chúng tôi thu thập gì, vì sao, và quyền kiểm soát bạn giữ. Nếu có gì chưa rõ, hãy viết tới info@briefasia.com, một con người, không phải bot, sẽ trả lời.",
        "Kami membangun BriefAsia untuk dibaca, bukan untuk ditambang. Kebijakan ini menjelaskan dengan bahasa sederhana: apa yang kami kumpulkan, mengapa, dan kendali yang Anda pegang. Jika ada yang kurang jelas, tulis ke info@briefasia.com, manusia, bukan bot, yang akan menjawab."
      ),
      body: [
        [
        ...
        [
          ...
          t(
            "On servers in Singapore, operated under our control. When the law of your country gives you stronger protections than ours, we apply the stronger standard. Questions about a specific jurisdiction go to info@briefasia.com.",
            "Trên máy chủ tại Singapore, do chúng tôi vận hành. Khi luật nước bạn cho bạn mức bảo vệ mạnh hơn của chúng tôi, chúng tôi áp dụng chuẩn cao hơn. Câu hỏi về một khu vực pháp lý cụ thể, gửi tới info@briefasia.com.",
            "Di server di Singapura, dioperasikan di bawah kendali kami. Bila hukum negara Anda memberi perlindungan lebih kuat dari kami, kami menerapkan standar yang lebih kuat. Pertanyaan tentang yurisdiksi tertentu kirim ke info@briefasia.com."
          ),
        ],
      ],
    },
    terms: {
      ...
      kicker: updated,
      intro: t(
        "These terms set out the agreement between you and Asia Press Centre Group (APCG) when you use briefasia. We have kept them short and readable on purpose. Using the site means you accept them.",
        "Các điều khoản này quy định thoả thuận giữa bạn và Asia Press Centre Group (APCG) khi bạn dùng briefasia. Chúng tôi cố ý giữ chúng ngắn gọn và dễ đọc. Việc sử dụng trang đồng nghĩa bạn chấp nhận chúng.",
        "Ketentuan ini mengatur perjanjian antara Anda dan Asia Press Centre Group (APCG) saat memakai briefasia. Kami sengaja membuatnya ringkas dan mudah dibaca. Menggunakan situs berarti Anda menerimanya."
      ),
      body: [
        [
        ...
        [
          ...
          t(
            "The journalism, data visualisations, and design on BriefAsia are owned by Asia Press Centre Group (APCG) or used under licence. Trademarks and the masthead remain ours. We license selected content for syndication, write to partnership@briefasia.com.",
            "Nội dung báo chí, đồ hoạ dữ liệu và thiết kế trên BriefAsia thuộc sở hữu của Asia Press Centre Group (APCG) hoặc dùng theo giấy phép. Thương hiệu và măng-sét vẫn thuộc về chúng tôi. Chúng tôi cấp phép một số nội dung để đăng lại, viết tới partnership@briefasia.com.",
            "Jurnalisme, visualisasi data, dan desain di BriefAsia dimiliki Asia Press Centre Group (APCG) atau dipakai berdasarkan lisensi. Merek dagang dan masthead tetap milik kami. Kami melisensikan konten tertentu untuk sindikasi, tulis ke partnership@briefasia.com."
          ),
        ],
        [
        ...
        [
          ...
          t(
            "If we change these terms materially, we will say so on this page and, for account holders, by email. Continued use after a change means acceptance. Governing law is Singapore. Questions: info@briefasia.com.",
            "Nếu chúng tôi thay đổi các điều khoản này một cách đáng kể, chúng tôi sẽ thông báo trên trang này và, với chủ tài khoản, qua email. Tiếp tục sử dụng sau thay đổi nghĩa là chấp nhận. Luật điều chỉnh là Singapore. Câu hỏi: info@briefasia.com.",
            "Jika kami mengubah ketentuan ini secara material, kami akan menyampaikannya di halaman ini dan, bagi pemilik akun, lewat email. Penggunaan berlanjut setelah perubahan berarti penerimaan. Hukum yang berlaku adalah Singapura. Pertanyaan: info@briefasia.com."
          ),
        ],
      ],
    },
    cookies: {
      ...
      body: [
        ...
        [
          ...
          t(
            "No advertising cookies. No third-party trackers. No cross-site pixels from social networks. If you ever find a cookie on BriefAsia that does not fit the two categories above, tell us, it is a bug, not a policy.",
            "Không cookie quảng cáo. Không trình theo dõi bên thứ ba. Không pixel xuyên trang từ mạng xã hội. Nếu bạn từng thấy một cookie trên BriefAsia không thuộc hai nhóm trên, hãy báo chúng tôi, đó là lỗi, không phải chính sách.",
            "Tanpa cookie iklan. Tanpa pelacak pihak ketiga. Tanpa piksel lintas situs dari media sosial. Jika Anda menemukan cookie di BriefAsia yang tak masuk dua kategori di atas, beri tahu kami, itu bug, bukan kebijakan."
          ),
        ],
        [
    ...
    gdpr: {
      ...
      body: [
        ...
        [
          ...
          t(
            "Email info@briefasia.com or use the export and deletion tools in your account. We respond within 30 days, usually far sooner, and we never charge for a reasonable request. We will verify your identity first, to protect you.",
            "Gửi email tới info@briefasia.com hoặc dùng công cụ xuất và xoá trong tài khoản. Chúng tôi phản hồi trong 30 ngày, thường nhanh hơn nhiều, và không bao giờ tính phí cho yêu cầu hợp lý. Chúng tôi sẽ xác minh danh tính trước, để bảo vệ bạn.",
            "Email info@briefasia.com atau gunakan alat ekspor dan penghapusan di akun Anda. Kami merespons dalam 30 hari, biasanya jauh lebih cepat, dan tak pernah memungut biaya untuk permintaan yang wajar. Kami akan memverifikasi identitas Anda dulu, demi melindungi Anda."
          ),
        ],
        [
        ...
        [
          ...
          t(
            "A named DPO oversees how we handle personal data and is your direct line for anything on this page. Reach them at info@briefasia.com.",
            "Một DPO được chỉ định giám sát cách chúng tôi xử lý dữ liệu cá nhân và là đầu mối trực tiếp của bạn cho mọi điều trên trang này. Liên hệ tại info@briefasia.com.",
            "Seorang DPO mengawasi cara kami menangani data pribadi dan menjadi saluran langsung Anda untuk apa pun di halaman ini. Hubungi di info@briefasia.com."
          ),
        ],
      ],
    },
      ...
      <div className="r-sidebar" style={{ display: "grid", gap: 48 }}>
        <nav style={{ position: "sticky", top: 160, alignSelf: "flex-start" }}>
          ...
          >
            ...
            <a
              href="mailto:info@briefasia.com"
