...
const EMAIL = "partnership@briefasia.com";
const MAILTO = `mailto:${EMAIL}?subject=BriefAsia%20media%20inquiry`;
...
export default function AdvertisePage() {
  ...
  const formats: ReadonlyArray<{
    ...
    },
    {
      ...
      desc: t(
        "Long-form features, research, and video told to a newsroom standard, produced and clearly labelled by BriefAsia Studio.",
        "Bài đặc tả dài, nghiên cứu và video theo chuẩn toà soạn, sản xuất và gắn nhãn rõ ràng bởi BriefAsia Studio.",
        "Fitur panjang, riset, dan video dengan standar redaksi, diproduksi dan diberi label jelas oleh BriefAsia Studio."
      ),
      note: t("via BriefAsia Studio →", "qua BriefAsia Studio →", "lewat BriefAsia Studio →"),
      to: "/studio",
    },
  ];
    ...
    <div className="container" style={{ paddingTop: 32, paddingBottom: 72, maxWidth: 980 }}>
      ...
      >
        ...
        <div style={{ position: "relative", maxWidth: 700 }}>
          <div className="kicker" style={{ color: "var(--accent)", marginBottom: 14 }}>
            {t("Advertise with BriefAsia", "Quảng cáo cùng BriefAsia", "Beriklan dengan BriefAsia")}
          </div>
          <h1
            className="serif"
            style={{
          ...
          >
            {t(
              "Founders, engineers, investors, and policymakers read BriefAsia to understand what is actually happening in technology. Put your brand in front of them, in a place built for attention, not impressions.",
              "Nhà sáng lập, kỹ sư, nhà đầu tư và nhà hoạch định chính sách đọc BriefAsia để hiểu điều thực sự đang diễn ra trong công nghệ. Đưa thương hiệu của bạn đến trước họ, ở một nơi được tạo ra cho sự chú tâm, không phải lượt hiển thị.",
              "Founder, engineer, investor, dan pembuat kebijakan membaca BriefAsia untuk memahami apa yang benar-benar terjadi di teknologi. Tempatkan merek Anda di depan mereka, di tempat yang dibangun untuk perhatian, bukan impresi."
            )}
          </p>
      ...
      <Reveal>
        <div className="kicker muted" style={{ marginBottom: 16 }}>
          {t("Why BriefAsia", "Vì sao chọn BriefAsia", "Kenapa BriefAsia")}
        </div>
        <div
          style={{
            display: "grid",
        ...
        >
          <div>
            <div className="kicker muted" style={{ marginBottom: 8 }}>
              {t("Who reads BriefAsia", "Ai đọc BriefAsia", "Siapa pembaca BriefAsia")}
            </div>
            <h2
              className="serif"
              style={{
        ...
        >
          ...
          <div>
            ...
            <p style={{ margin: 0, fontSize: 13.5, lineHeight: 1.6, color: "var(--ink-2)", maxWidth: 720 }}>
              {t(
                "Buying a placement never buys coverage, and it never influences what we report. Paid content is clearly labelled and produced by BriefAsia Studio, not our reporters. The rules are public.",
                "Mua một vị trí quảng cáo không bao giờ mua được tin bài, và không bao giờ ảnh hưởng đến nội dung chúng tôi đưa tin. Nội dung trả phí được gắn nhãn rõ ràng và do BriefAsia Studio sản xuất, không phải phóng viên của chúng tôi. Các quy tắc được công khai.",
                "Membeli penempatan tak pernah membeli liputan, dan tak pernah memengaruhi apa yang kami beritakan. Konten berbayar diberi label jelas dan diproduksi BriefAsia Studio, bukan reporter kami. Aturannya publik."
              )}
            </p>
