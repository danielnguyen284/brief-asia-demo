...
const MAILTO = `mailto:${EMAIL}?subject=BriefAsia%20Studio%20inquiry`;
  ...
  const services: ReadonlyArray<{ icon: IconName; label: string; desc: string }> = [
    ...
    },
    {
      ...
      desc: t(
        ...
        "Chuyên mục podcast thương hiệu, phim tài liệu ngắn và toạ đàm tại sự kiện của chúng tôi, sản xuất trọn gói, phân phối trên các kênh của BriefAsia.",
      ...
      >
        ...
        <div style={{ position: "relative", maxWidth: 680 }}>
          <div className="kicker" style={{ color: "var(--accent)", marginBottom: 14 }}>
            {t("BriefAsia Studio", "BriefAsia Studio", "BriefAsia Studio")}
          </div>
          <h1
            className="serif"
            style={{
          ...
          >
            {t(
              "BriefAsia Studio is our branded-content team. We work with partners to tell their story to an audience that reads us for tech across Asia and the world, researched, written, and produced with the same care as our journalism, and labelled clearly so trust stays intact on both sides.",
              "BriefAsia Studio là đội nội dung thương hiệu của chúng tôi. Chúng tôi đồng hành cùng đối tác để kể câu chuyện của họ tới những độc giả đọc BriefAsia vì công nghệ khắp châu Á và thế giới, nghiên cứu, chấp bút và sản xuất kỹ lưỡng như báo chí của chúng tôi, và gắn nhãn minh bạch để giữ niềm tin cho cả hai phía.",
              "BriefAsia Studio adalah tim konten bermerek kami. Kami bekerja dengan mitra untuk menyampaikan kisah mereka kepada pembaca yang mengikuti BriefAsia demi teknologi di Asia dan dunia, diriset, ditulis, dan diproduksi dengan kehati-hatian yang sama seperti jurnalisme kami, serta diberi label jelas agar kepercayaan tetap terjaga di kedua sisi."
            )}
          </p>
          <a
            href={MAILTO}
