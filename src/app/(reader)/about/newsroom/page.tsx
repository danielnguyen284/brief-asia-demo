...
const MASTHEAD: ReadonlyArray<{ name: string; role: string; city: string }> = [
  { name: "Cheryl Tan", role: "Editor-in-Chief, BriefAsia / Group Editor", city: "Singapore" },
...
export default function NewsroomAboutPage() {
  ...
  const heroSub: ReactNode =
    lang === "vi" ? (
      <>
        BriefAsia là ấn phẩm công nghệ của{" "}
      ...
      <>
        BriefAsia adalah publikasi teknologi dari{" "}
        <strong style={{ color: BANNER_HEADING }}>Asia Press Centre Group (APCG)</strong>.{" "}
      ...
      <>
        BriefAsia is the technology title of{" "}
        <strong style={{ color: BANNER_HEADING }}>Asia Press Centre Group (APCG)</strong>.{" "}
      ...
      <div className="container" style={{ paddingTop: 64, paddingBottom: 80 }}>
        ...
        <Reveal>
          <section style={{ marginBottom: 80 }}>
            ...
            >
              ...
              >
                Editor-in-Chief, BriefAsia · Asia Press Centre Group
              </div>
              ...
              >
                ...
                briefasia, where she sets the title&apos;s editorial direction and the standards
        ...
        <div style={{ marginTop: 48 }}>
          <Link href="/about" className="linkish" style={{ color: "var(--accent)", fontSize: 14 }}>
            {t(
              "← The trust & standards view of briefasia",
              "← Trang minh bạch & chuẩn mực của briefasia",
              "← Tampilan kepercayaan & standar briefasia"
            )}
          </Link>
        </div>
      </div>
