// BriefAsia sample data — ported from design/project/src/data.jsx
...
export const PILLARS: ReadonlyArray<Pillar> = [
  ...
  { id: "finance", label: "Finance", color: "var(--finance)", slug: "/finance" },
  { id: "technology", label: "Technology", color: "var(--technology)", slug: "/technology" },
  { id: "real-estate", label: "Real Estate", color: "var(--real-estate)", slug: "/real-estate" },
  { id: "travel-dining", label: "Travel & Dining", color: "var(--travel-dining)", slug: "/travel-dining" },
  { id: "lifestyle", label: "Lifestyle", color: "var(--lifestyle)", slug: "/lifestyle" },
  { id: "sustainability", label: "Sustainability", color: "var(--sustainability)", slug: "/sustainability" },
  { id: "perspectives", label: "Perspectives", color: "var(--perspectives)", slug: "/perspectives" },
];
...
export const PILLAR_ICONS: Record<PillarId, string> = {
  ...
  "travel-dining": "globe",
  lifestyle: "star",
  sustainability: "trend-up",
  perspectives: "feather",
};
...
export function authorOf(id: string): Author {
  return AUTHORS[id] ?? { id, name: "Staff", role: "BriefAsia", city: "" };
}
...
export const NEWSLETTERS: ReadonlyArray<Newsletter> = [
  { id: "morning", name: "Morning Brief", cadence: "Weekdays · 07:00 SGT", desc: "The flagship 5-minute read for Asia decision-makers.", subs: "52,000", pillar: "asia" },
  { id: "finance", name: "Finance Weekly", cadence: "Fridays", desc: "Banking, capital markets, fintech, and consequential regional deals.", subs: "31,500", pillar: "finance" },
  { id: "tech", name: "Tech Weekly", cadence: "Thursdays", desc: "AI, startups, platforms, infrastructure, and funding signals.", subs: "36,400", pillar: "technology" },
  { id: "travel", name: "Travel & Lifestyle Weekly", cadence: "Saturdays", desc: "Hotels, tables, destinations, luxury, and spending shifts.", subs: "18,600", pillar: "travel-dining" },
  { id: "esg", name: "ESG Monthly", cadence: "First of the month", desc: "Green finance, energy transition, and circular-economy moves.", subs: "14,900", pillar: "sustainability" },
];
...
export const PODCASTS: ReadonlyArray<Podcast> = [
  { id: "daily", title: "BriefAsia Daily Brief", len: "6:42", date: "Today", host: "Mei Lin" },
