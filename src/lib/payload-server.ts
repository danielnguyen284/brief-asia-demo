...
import type { Article, Pillar, Author, WireDrop, Tag, Correction, MarketSnapshot } from "../payload/payload-types";
...
export const getArticlesPage = unstable_cache(
  async (
    ...
    const and: Where[] = [{ _status: { equals: "published" } }, { pillar: { equals: pillarId } }];
...
export const getMarketSnapshots = unstable_cache(
  ...
  ["market-snapshots"],
  { tags: ["market-snapshots"], revalidate: 60 }
);

export type { Article, Pillar, Author, WireDrop, Tag, Correction, MarketSnapshot };
