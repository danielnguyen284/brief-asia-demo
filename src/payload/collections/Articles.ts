...
export const Articles: CollectionConfig = {
  ...
  admin: {
    useAsTitle: "title",
    defaultColumns: ["title", "pillar", "country", "status", "origin", "version", "publishedAt"],
    description:
      "Every story BriefAsia publishes. Engine drafts flow in via API; editors review here.",
      ...
      tabs: [
          ...
          fields: [
            {
              ...
              relationTo: "pillars",
              required: true,
              admin: { description: "One primary BriefAsia vertical per article." },
            },
            {
              name: "country",
              type: "relationship",
              relationTo: "countries",
              admin: { description: "Optional country or market focus." },
            },
        ...
        },
        {
          ...
          fields: [
            ...
            {
              name: "engineSourceContext",
              type: "textarea",
              admin: {
                description: "Source notes, provenance summary, or engine rationale for editors.",
                readOnly: true,
                position: "sidebar",
              },
            },
            {
              name: "translationAssisted",
              type: "checkbox",
              defaultValue: false,
              admin: {
                description: "Reader-visible when source-language material was translated with assistance.",
              },
            },
          ],
        },
